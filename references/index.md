...
| Contiguous DRAM + validated roofline (B_DRAM_contiguous, empirical ridges) | [hardware/dram-contiguous-roofline.md](hardware/dram-contiguous-roofline.md) | DRAM contiguous roofline campaign |
...
| GEMM/GEMV boundary interpolation sweep (M gaps around 16/64/192) | [techniques/gemm-crossover-boundary.md](techniques/gemm-crossover-boundary.md) | GEMM boundary sweep campaign |
...
| RMSNorm paired/interleaved tie verification (selected rows/hidden, f32/f16/bf16) | [rmsnorm-paired-bench.md](rmsnorm-paired-bench.md) | RMSNorm paired tie campaign |
